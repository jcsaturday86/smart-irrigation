<div wire:poll.10s class="space-y-6">
    <x-page-header
        icon="home"
        title="Dashboard"
        subtitle="Monitor and control your irrigation system" />

    <x-flash-message />

    {{-- Mode Selector Hero --}}
    <div class="ui-card">
        <div class="bg-zinc-50 px-6 py-10 text-center dark:bg-zinc-800/40">
            <div class="mx-auto mb-5 flex h-24 w-24 items-center justify-center rounded-full bg-emerald-100 dark:bg-emerald-900/40">
                <div class="flex h-16 w-16 items-center justify-center rounded-full bg-emerald-500 shadow-lg shadow-emerald-500/40">
                    @if($mode == 'manual')
            ...
            <p class="text-2xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100">{{ ucfirst($mode) }} Mode</p>
            ...
            <div class="grid grid-cols-3 gap-3">
                <button wire:click="setMode('manual')"
                        ...
                        {{ $mode == 'manual'
                            ...
                            : 'border border-zinc-200 bg-white text-zinc-600 shadow-sm hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-700 dark:border-zinc-700 dark:bg-zinc-800/50 dark:text-zinc-300 dark:hover:border-emerald-700 dark:hover:bg-emerald-950/20 dark:hover:text-emerald-400' }}">
    ...
    <div class="ui-card">
        <div class="ui-card-header">
            ...
            <flux:text class="text-xs text-zinc-400">Auto-refreshes every 10s</flux:text>
        </div>
        <div class="ui-grid-divider grid grid-cols-2 lg:grid-cols-4">
            {{-- Irrigation --}}
    ...
    <div class="ui-card">
        ...
        <div class="ui-grid-divider grid grid-cols-3">
            <div class="ui-grid-cell gap-1">
                <p class="text-3xl font-bold tabular-nums text-zinc-900 dark:text-zinc-100">{{ $totalCrops }}</p>
                <flux:text class="ui-tile-label">Crops</flux:text>
            </div>
            <div class="ui-grid-cell gap-1">
                <p class="text-3xl font-bold tabular-nums text-zinc-900 dark:text-zinc-100">{{ $totalUsers }}</p>
                <flux:text class="ui-tile-label">Users</flux:text>
            </div>
            <div class="ui-grid-cell gap-1 px-4">
        ...
        @if($activities->count())
            <div class="divide-y divide-zinc-200 dark:divide-zinc-800">
                @foreach($activities as $activity)
                    <div class="flex items-center justify-between gap-3 px-5 py-3.5 transition-colors hover:bg-zinc-50 sm:px-6 dark:hover:bg-zinc-800/40">
